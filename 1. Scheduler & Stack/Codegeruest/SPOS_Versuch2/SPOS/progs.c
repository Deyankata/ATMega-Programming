...
#define TEST_SS_ROUND_ROBIN 1      // Optional in Versuch 2
#define TEST_SS_INACTIVE_AGING 1    // Optional in Versuch 2
#define TEST_SS_RUN_TO_COMPLETION 1 // Optional in Versuch 2
#define PHASE_1 1
#define PHASE_2 1
#define PHASE_3 1
#define PHASE_4 1
